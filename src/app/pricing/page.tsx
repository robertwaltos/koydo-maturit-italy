...
export const metadata: Metadata = {
  title: "Pricing — Maturit Italy Premium",
  description: "Unlock unlimited Maturit Italy practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=maturit-italy&cadence=annual`;

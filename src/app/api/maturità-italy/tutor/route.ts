...
const EXAM_ID = "maturità-italy";
const EXAM_DISPLAY_NAME = "Esame di Maturità (Esame di Stato)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Rispondi sempre in italiano.

Copri tutte le materie dell'Esame di Stato: Italiano (prima prova), materia d'indirizzo (seconda prova), colloquio orale. Adatta al tipo di liceo/istituto tecnico.
